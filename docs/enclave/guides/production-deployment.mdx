...
flowchart TB
    ...
    style app fill:#f0b865,stroke:#c78935,color:#333
    style API fill:#e8a045,stroke:#c78935,color:#fff
    style Enclave fill:#e8a045,stroke:#c78935,color:#fff
```
...
flowchart TB
    ...
    style appTier fill:#fff5e6,stroke:#c78935,color:#333
    style orchTier fill:#fff5e6,stroke:#c78935,color:#333
    style execTier fill:#fff5e6,stroke:#c78935,color:#333
