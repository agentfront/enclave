...
cd code-editor
npm install @enclavejs/react @enclavejs/client @monaco-editor/react
```
...
The `@enclavejs/react` package provides pre-built hooks:
...
- [@enclavejs/react](/enclavejs/react) - React SDK reference
- [@enclavejs/client](/enclavejs/client) - Client SDK reference
