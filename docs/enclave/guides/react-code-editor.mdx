...
flowchart TB
    subgraph frontend["React Frontend"]
        subgraph editor["Code Editor Component"]
            Monaco["Monaco Editor"]
            Output["Output Panel"]
        end
        Hook["useEnclave() / EnclaveClient"]
    end
    Broker["EnclaveJS Broker"]
    editor --> Hook
    Hook -->|"WebSocket/HTTP"| Broker
    style frontend fill:#fff5e6,stroke:#c78935,color:#333
    style editor fill:#f0b865,stroke:#c78935,color:#333
    style Monaco fill:#e8a045,stroke:#c78935,color:#fff
    style Output fill:#e8a045,stroke:#c78935,color:#fff
    style Hook fill:#f0b865,stroke:#c78935,color:#333
