...
<CardGroup cols={3}>
  <Card title="15 Built-in Rules" icon="shield">
...
```ts
import { createPreScannerConfig, analyzeForReDoS } from '@enclave-vm/ast';
...
- [GitHub](https://github.com/agentfront/enclave/tree/main/libs/ast)
- [npm](https://www.npmjs.com/package/@enclave-vm/ast)
