---
title: '@enclavejs/runtime API'
description: 'API reference for the EnclaveJS runtime package'
---

API reference for the `@enclavejs/runtime` package - the execution worker for distributed EnclaveJS deployments.
...
```ts
import { EnclaveRuntime } from '@enclavejs/runtime';
...
- [@enclavejs/broker](/api-reference/enclavejs-broker) - Broker API
