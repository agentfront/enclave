---
title: '@enclavejs/react API'
description: 'API reference for the EnclaveJS React SDK'
---

API reference for the `@enclavejs/react` package - React hooks and components for EnclaveJS.

## Installation

```bash
npm install @enclavejs/react @enclavejs/client
```
...
```tsx
import { EnclaveProvider } from '@enclavejs/react';
...
```tsx
import { useEnclave } from '@enclavejs/react';
...
```tsx
import { useEnclave, useExecutionStream } from '@enclavejs/react';
...
```tsx
import { useEnclave, useExecutionStream, useToolHandler } from '@enclavejs/react';
...
```tsx
import { Console } from '@enclavejs/react';
...
```tsx
import { ToolCallList } from '@enclavejs/react';
...
```tsx
import { ExecutionStatus } from '@enclavejs/react';
