...
<CardGroup cols={3}>
  ...
  <Card title="vectoriadb" icon="database" href="/core-libraries/vectoriadb/overview">
    Lightweight in-memory vector database with HNSW indexing for semantic search
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="@enclavejs/broker" icon="server" href="/enclavejs/broker">
    Tool broker with session management and HTTP API
  </Card>
  <Card title="@enclavejs/client" icon="plug" href="/enclavejs/client">
    Browser and Node.js client SDK
  </Card>
  <Card title="@enclavejs/react" icon="react" href="/enclavejs/react">
...
# Streaming runtime
npm install @enclavejs/broker @enclavejs/client @enclavejs/react
```
